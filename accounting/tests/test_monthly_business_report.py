...
class MonthlyBusinessReportTest(TestCase):
    ...
    def test_sales_income_cost_structure_and_zero_base_comparison(self):
        ...
        self.assertEqual(report['customers']['new_customer_rate'], Decimal('1.0000'))
        self.assertEqual(report['customers']['repeat_customer_rate'], Decimal('1.0000'))
        self.assertEqual(report['customers']['fulfilled_order_count'], 2)
        self.assertEqual(report['customers']['average_order_revenue_cny'], Decimal('95.00'))
        self.assertEqual(report['customers']['identified_customer_revenue_cny'], Decimal('190.00'))
    ...
    def test_historical_inventory_uses_ledger_and_customer_identity_excludes_guests(self):
        ...
        self.assertEqual(report['customers']['fulfilled_order_count'], 4)
        self.assertEqual(report['customers']['average_order_revenue_cny'], Decimal('22.50'))
        self.assertEqual(report['customers']['identified_customer_revenue_cny'], Decimal('70.00'))
