...
from privnote.views import create_note, api_privnote
...
urlpatterns = [
    ...
    path('privnote/create/', create_note, name='privnote_create'),
    # SPA catch-all (must be last)
    re_path(r'^(?!admin/|api/|static/|media/|privnote/create/).*$', spa_index, name='spa_index'),
]
