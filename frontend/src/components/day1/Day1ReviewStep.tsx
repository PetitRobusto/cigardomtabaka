...
export default function Day1ReviewStep({ draft, errors, readOnly = false, confirmationOpen = false, acknowledged = false, onPrepare, onAcknowledge, onCancel, onConfirm, confirming = false }: Props) {
