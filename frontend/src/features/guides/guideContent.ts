...
export const MANUAL_CHAPTERS: readonly ManualChapter[] = [
...

  {
    ...
    sections: [
      ...
      guidedSection('accounting-profit-month', '查看月度经营报告', '进入独立月报页选择月份，再逐项核对销售收入、商品成本、实际人肉成本、日常费用、回款和库存。退款和冲正会算进实际发生的月份。'),
...

  {
    ...
    sections: [
      ...
      guidedSection('sales-item-unit', '填写包装、数量和售价', '按整盒卖，数量填盒数，注意核对每盒支数；按单支卖，数量填支数。售价一律填人民币单价，别把卢布采购成本填进来——商品成本由系统根据实际出库批次自动计算。'),
