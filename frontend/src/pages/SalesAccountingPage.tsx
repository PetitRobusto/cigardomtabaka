...
export default function SalesAccountingPage() {
  ...
  return <div className="w-full animate-fade-in">
    ...
    <div id="accounting" className="mt-7"><AccountingPanel accounts={accountsQuery.data || []} summary={summaryQuery.data} profit={profitQuery.data} reconciliations={reconQuery.data || []} month={month} onChanged={refresh} /></div>
  </div>;
}
