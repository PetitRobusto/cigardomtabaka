...
describe('business workspace review boundaries', () => {
  it('resolves the legacy hash and keeps all business entry paths staff-gated', () => {
    ...
    expect(BUSINESS_STAFF_PATHS).toStrictEqual({ inventory: '/inventory', inventoryPurchases: '/inventory/purchases', sales: '/sales', salesReceipts: '/sales/receipts', salesCustomers: '/sales/customers', accounting: '/accounting', day1: '/accounting/day1', monthlyReport: '/reports/monthly', contributionRanking: '/reports/contributions' });
