"""Import full COH browser scrape output through the unified ingestion module."""
import json
...
class Command(BaseCommand):
    help = '从浏览器导出的 COH 全站 JSON 导入 PriceSnapshot'

    def add_arguments(self, parser):
        parser.add_argument('json_file', help='COH 全站 JSON 文件路径，格式: {slug: [{name, price, box_info}]}')
